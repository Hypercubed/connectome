...
(function() {
  ...
  app
    .service('ligandReceptorData', function() {  // TODO: everything
      var service = {};
  ...
  app
    .service('chartManager', function() {  // TODO: everything
      var service = {};
  ...
  app
    .controller('PanelCtrl', function ($scope, $log, $http, $q, cfpLoadingBar, localStorageService, ligandReceptorData, PAIRSFILE, EXPRESSIONFILE) {

      /* Load Data */

      var selected = $scope.selected = {};
      $scope.selected.pairs = [];
      $scope.selected.cells = [];
      ...
      chart.nodeTooltip.html(function(d) {
        ...
        return html.map(function(d) {return d.join(' '); }).join('<br>');
      });
